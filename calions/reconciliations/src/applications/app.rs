use crate::consumers::ReconciliationDataConsumer;
use crate::processors::{ReconciliationMsg, ReconciliationProcessor, StatusMsg, StatusProcessor};
use crate::producers::{ReconciliationDataProducer, ReconciliationDataProducerSender};
...
impl App {
    pub async fn start() -> Result<(), DataStreamError> {
        ...
        let reconciliation_data_producer_sender: ReconciliationDataProducerSender =
            Producer::spawn(ReconciliationDataProducer::new(), Some(100))?;
        ...
        Consumer::spawn(
            ReconciliationDataConsumer::new(),
