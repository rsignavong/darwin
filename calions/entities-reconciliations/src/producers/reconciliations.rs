...
const NAME: &'static str = "ReconiliationsProducer";

pub type ReconciliationsProducerSender = ProducerSender<Record, RecordBody, RecordMetadata>;

#[derive(Clone, new)]
pub struct ReconciliationsProducer {
    topic: Arc<ProcessorTopic>,
}

impl StreamProducer for ReconciliationsProducer {
